...
def load_relevant_knowledge(user_input: str) -> str:
    keywords_map = {
        ...
        # Расчёт графика
        "рассчитай график": "Данные для расчёта графика.md",
        "рассчитай время": "Данные для расчёта графика.md",
        "график": "Данные для расчёта графика.md",
        "сколько можно ехать": "Данные для расчёта графика.md",
